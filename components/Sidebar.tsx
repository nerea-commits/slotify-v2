...
export default function Sidebar({
  ...
  empresaNombre, profesionalNombre, isAdmin,
  ...
  function renderItem(id: string, label: string, Icon: any) {
    ...
    return (
      ...
      >
        <Icon size={17} style={{ flexShrink: 0, color: active ? '#22C55E' : '#64748B', strokeWidth: active ? 2.5 : 1.8 }} />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 11, minWidth: 0 }}>
          ...
          {!collapsed && (
            <div style={{ minWidth: 0 }}>
              ...
              <p style={{ fontSize: 11, color: '#22C55E', fontWeight: 600, letterSpacing: 0.4, marginTop: 1 }}>
